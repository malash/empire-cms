...
?><tr><td bgcolor=ffffff>圖片名稱</td><td bgcolor=ffffff>
...
<select name="select" onchange="document.add.filesize.value+=this.value">
      ...
      </select></td></tr><tr><td bgcolor=ffffff>圖片尺寸</td><td bgcolor=ffffff><input name="picsize" type="text" id="picsize" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[picsize]))?>" size="">
</td></tr><tr><td bgcolor=ffffff>圖片分辨率</td><td bgcolor=ffffff><input name="picfbl" type="text" id="picfbl" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[picfbl]))?>" size="">
</td></tr><tr><td bgcolor=ffffff>來源</td><td bgcolor=ffffff><input name="picfrom" type="text" id="picfrom" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[picfrom]))?>" size="60">
</td></tr><tr><td bgcolor=ffffff>圖片小圖</td><td bgcolor=ffffff><input name="titlepic" type="text" id="titlepic" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[titlepic]))?>" size="45">
...
</td></tr><tr><td bgcolor=ffffff>圖片大圖</td><td bgcolor=ffffff><input name="picurl" type="text" id="picurl" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[picurl]))?>" size="45">
...
</td></tr><tr><td bgcolor=ffffff>圖片集</td><td bgcolor=ffffff><script>
function dopicadd()
{var i;
var str="";
var oldi=0;
...
</td></tr><tr><td bgcolor=ffffff>每行顯示條數</td><td bgcolor=ffffff><input name="num" type="text" id="num" value="<?=$ecmsfirstpost==1?"3":ehtmlspecialchars(stripSlashes($r[num]))?>" size="">
</td></tr><tr><td bgcolor=ffffff>縮圖寬度</td><td bgcolor=ffffff><input name="width" type="text" id="width" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[width]))?>" size="6">
</td></tr><tr><td bgcolor=ffffff>縮圖高度</td><td bgcolor=ffffff><input name="height" type="text" id="height" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[height]))?>" size="6">
</td></tr><tr><td bgcolor=ffffff>圖片簡介</td><td bgcolor=ffffff><textarea name="picsay" cols="80" rows="10" id="picsay"><?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[picsay]))?></textarea>
</td></tr>