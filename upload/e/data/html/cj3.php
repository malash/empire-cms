...
?>
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>圖片名稱正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>圖片尺寸正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>圖片分辨率正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>來源正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>圖片小圖正則：</strong><br>
      ( 
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>圖片大圖正則：</strong><br>
      ( 
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>圖片集正則：</strong><br>
      (
...
<input name="add[save_morepic]" type="checkbox" id="add[save_morepic]" value=" checked"<?=$r[save_morepic]?>>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>每行顯示條數正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>縮圖寬度正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>縮圖高度正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>圖片簡介正則：</strong><br>
