...
?>
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>商品名稱正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>商品編號正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>品牌正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>簡單描述正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>計量單位正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>單位重量正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>市場價格正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>購買價格正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>積分購買正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>庫存正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>商品縮略片正則：</strong><br>
      ( 
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>商品大圖正則：</strong><br>
      ( 
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>商品介紹正則：</strong><br>
