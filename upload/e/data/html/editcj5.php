...
</td></tr><tr><td bgcolor=ffffff>影片縮略圖</td><td bgcolor=ffffff><input name="titlepic" type="text" id="titlepic" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[titlepic]))?>" size="45">
...
</td></tr><tr><td bgcolor=ffffff>影片類型</td><td bgcolor=ffffff><select name="movietype" id="movietype"><option value="港台影視"<?=$r[movietype]=="港台影視"?' selected':''?>>港台影視</option><option value="海外影視"<?=$r[movietype]=="海外影視"?' selected':''?>>海外影視</option><option value="大陸影視"<?=$r[movietype]=="大陸影視"?' selected':''?>>大陸影視</option><option value="日韓影視"<?=$r[movietype]=="日韓影視"?' selected':''?>>日韓影視</option></select></td></tr><tr><td bgcolor=ffffff>出品公司</td><td bgcolor=ffffff>
<input name="company" type="text" id="company" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[company]))?>" size="">
</td></tr><tr><td bgcolor=ffffff>出品時間</td><td bgcolor=ffffff>
...
</td></tr><tr><td bgcolor=ffffff>導演</td><td bgcolor=ffffff>
...
</td></tr><tr><td bgcolor=ffffff>在線觀看地址</td><td bgcolor=ffffff><script>
function dooadd()
{var i;
var str="";
var oldi=0;
...
</td></tr><tr><td bgcolor=ffffff>影片簡介</td><td bgcolor=ffffff><textarea name="moviesay" cols="80" rows="10" id="moviesay"><?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[moviesay]))?></textarea>
</td></tr>