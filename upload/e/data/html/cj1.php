...
?>  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>標題正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>副標題正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td height="22" valign="top"><strong>標題圖片正則：</strong><br>
      ( 
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>內容簡介正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>信息來源正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>新聞正文正則：</strong><br>
