...
?>
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>作品名正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>作品預覽圖正則：</strong><br>
      ( 
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>作者正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>作者郵箱正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>作品評價正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>Flash地址正則：</strong><br>
      ( 
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>Flash寬度正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>Flash高度正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>作品簡介正則：</strong><br>
