...
?>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>信息內容正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>圖片正則：</strong><br>
      ( 
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>所在地正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>聯繫郵箱正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>聯繫方式正則：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>聯繫地址正則：</strong><br>
