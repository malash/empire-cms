...
<body scroll="no" style="overflow: hidden">
  ...
  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" id="tranpictb">
    <form id="frmUpload" name="TranImgFormT" method="post" target="UploadWindow" enctype="multipart/form-data" action="../../../../DoInfo/ecms.php" onsubmit="return DoCheckTranFile(document.TranImgFormT);">
      ...
      <tr> 
        <td>本地上傳<br> <input type="file" name="file" id="txtUploadFile" style="width: 100%"> 
        </td>
      </tr>
      <tr> 
