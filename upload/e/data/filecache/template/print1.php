...
<title><?=ehtmlspecialchars($r[title])?> 打印頁面 - Powered by EmpireCMS</title>
<meta name="keywords" content="<?=ehtmlspecialchars($r[title])?> 打印頁面" />
<meta name="description" content="<?=ehtmlspecialchars($r[title])?> 打印頁面" />
<style>
