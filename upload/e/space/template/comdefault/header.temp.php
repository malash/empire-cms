...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="F7F7F7">
  <tr>
    ...
    <td align="right"><a href="<?=$public_r[newsurl]?>">網站首頁</a> | <a onClick="window.external.addFavorite('<?=$spaceurl?>','<?=$spacename?>')" href="#ecms">加入收藏</a> 
      | <a onClick="this.style.behavior='url(#default#homepage)';this.setHomePage('<?=$spaceurl?>')" href="#ecms">設為首頁</a></td>
 </tr>
</table>
<table width="778" height="108" border="0" align="center" cellpadding="0" cellspacing="8" background="template/default/images/head_bg.gif">
  <tr> 
    <td valign="middle"><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          <td width="15%"></td>
          <td><font style="font-family:細明體;font-size:20px;color:FFFFFF;font-weight:normal;font-style:normal;"><strong><?=$spacename?></strong></font><br><span style='line-height=15pt'><a href="<?=$spaceurl?>"><font color="ffffff"><?=$spaceurl?></font></a></span></td>
        </tr>
      </table></td>
  </tr>
</table>
...
<table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="10">&nbsp;</td>
          <td width="70" height="24" onMouseOver="ChangeMenuBg(this,mhome)" onMouseOut="ChangeMenuBg2(this,mhome)" align="center" onClick="self.location.href='index.php?userid=<?=$userid?>';"><font color="#FFFFFF" id="mhome"><strong>空間首頁</strong></font></td>
			<?=$dhmenu?>
          <td width="70" height="24" onMouseOver="ChangeMenuBg(this,muserinfo)" onMouseOut="ChangeMenuBg2(this,muserinfo)" align="center" onClick="self.location.href='UserInfo.php?userid=<?=$userid?>';"><font color="#FFFFFF" id="muserinfo"><strong>公司介紹</strong></font></td>
		  <td width="70" height="24" onMouseOver="ChangeMenuBg(this,mfeedback)" onMouseOut="ChangeMenuBg2(this,mfeedback)" align="center" onClick="self.location.href='feedback.php?userid=<?=$userid?>';"><font color="#FFFFFF" id="mfeedback"><strong>反饋信息</strong></font></td>
  ...
  <tr>
    <td height="23" bgcolor="B3DBF5">&nbsp;&nbsp;您現在的位置：
      <?=$url?>
    </td>
  </tr>
</table>
        ...
        <tr>
          <td width="220" valign="top"> <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#96C8F1">
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#96C8F1">
              <tr> 
                <td background="template/default/images/bg_title_sider.gif"><strong>用戶菜單</strong></td>
              </tr>
              <tr> 
                <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="6" cellpadding="3">
                    <tr> 
                      <td height="25"><a href="../member/friend/add/?fname=<?=$username?>" target="_blank">加為好友</a></td>
                      <td><a href="../member/msg/AddMsg/?username=<?=$username?>" target="_blank">發短消息</a></td>
                    </tr>
                    <tr> 
                      <td height="25"><a href="UserInfo.php?userid=<?=$userid?>">用戶資料</a></td>
			...
			<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#96C8F1">
			<tr>
				<td background="template/default/images/bg_title_sider.gif">訪問統計：<?=$addur[viewstats]?></td>
			</tr>
			</table>
          </td>
