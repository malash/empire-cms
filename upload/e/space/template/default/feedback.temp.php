...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#96C8F1">
  <tr> 
    <td background="template/default/images/bg_title_sider.gif"><b>在線反饋</b></td>
  </tr>
  <tr> 
    <td bgcolor="#FFFFFF">
          ...
          <tr>
            ...
            <td><table width="160" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  ...
                  <td width="85"><img src="<?=$public_r[newsurl]?>e/ShowKey/?v=spacefb" name="spacefbKeyImg" id="spacefbKeyImg" onclick="spacefbKeyImg.src='<?=$public_r[newsurl]?>e/ShowKey/?v=spacefb&t='+Math.random()" title="看不清楚,點擊刷新" /></td>
                </tr>
              </table></td>
          </tr>
          <tr> 
