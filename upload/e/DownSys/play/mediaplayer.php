  ...
  <TABLE border=0 cellPadding=0 cellSpacing=0 width="362">
    ...
    <TR>
      ...
      <TD bgcolor="#000000" colspan="2" width="340" height="250">
        ...
        <OBJECT classid="clsid:22D6F312-B0F6-11D0-94AB-0080C74C7E95" id=Player codebase="http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=5,1,52,701" standby="加載 Microsoft Windows Media Player 組件..." type="application/x-oleobject" width="340" height="250">
...
<SCRIPT FOR="Player" EVENT="Error( )" LANGUAGE="JScript">
        ...
        info.innerHTML="服務器正忙，請稍候再試……"
</SCRIPT>

<SCRIPT FOR="Player" EVENT="OpenStateChange(lOldState, lNewState)" LANGUAGE="JScript">
        switch(lNewState){
        case 0:
                info.innerHTML="服務器正忙，連接關閉……";
                window.clearInterval(m_timer);break;
        case 4:
                info.innerHTML="正在連接服務器……";break;
        case 5:
                info.innerHTML="正在打開文件……";break;
        case 6:
                info.innerHTML="準備播放……";StreamMedia();break;
        }
</SCRIPT>
