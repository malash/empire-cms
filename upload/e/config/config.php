...
$ecms_config['db']['dbpassword']='';	//數據庫密碼
$ecms_config['db']['dbname']='ecms72';	//數據庫名
$ecms_config['db']['setchar']='big5';	//設置默認編碼
$ecms_config['db']['dbchar']='big5';	//數據庫默認編碼
...
//頁面編碼設置
$ecms_config['sets']['pagechar']='big5';	//安裝帝國CMS的編碼版本
...
//後台安全設置
$ecms_config['esafe']['loginauth']='';	//登錄認證碼,如果設置登錄需要輸入此認證碼才能通過
$ecms_config['esafe']['ecookiernd']='www.phome.net';	//後台登錄COOKIE認證碼(填寫10~50個任意字符，最好多種字符組合)
...
$ecms_config['cks']['ckvarpre']='ecms';		//前台cookie變量前綴
$ecms_config['cks']['ckadminvarpre']='adminecms';		//後台cookie變量前綴
$ecms_config['cks']['ckrnd']='www.phome.net';	//COOKIE驗證隨機碼(填寫10~50個任意字符，最好多種字符組合)
$ecms_config['cks']['ckrndtwo']='www.phome.net';	//COOKIE驗證隨機碼2(填寫10~50個任意字符，最好多種字符組合)
