...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableborder">
  <tr class="header">
    <td height="25">標題:<?=$r[title]?>&nbsp;(<?=$voteclass?>)</td>
  </tr>
  <tr>
...
?>
  ...
  <tr>
    <td><table width="100%" border="0" align="right" cellpadding="3" cellspacing="1">
        <tr>
          <td>發佈時間：<?=$r[addtime]?>，&nbsp;&nbsp;共&nbsp;<b><?=$r[votenum]?></b>&nbsp;票</td>
        </tr>
      </table></td>
  </tr>
</table>
...
<br>
<br>
<center><input type=button name=button value=關閉 onclick="self.window.close();"></center>
</body>
</html>