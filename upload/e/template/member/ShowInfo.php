...
for($i=0;$i<$count-1;$i++)
{
	...
	elseif(strstr($formr['imgf'],",".$er1[1].","))//圖片
	{
		if($addr[$er1[1]])
		{
...
$public_diyr['pagetitle']='查看 '.$username.' 的會員資料';
$url="<a href='../../../'>首頁</a>&nbsp;>&nbsp;<a href='../cp/'>會員中心</a>&nbsp;>&nbsp;查看會員資料";
require(ECMS_PATH.'e/template/incfile/header.php');
?>
<table width='100%' border='0' align='center' cellpadding='3' cellspacing='1' class="tableborder">
  <tr class="header"> 
    <td height="25" colspan="2">查看 <?=$username?> 的會員資料</td>
  </tr>
  <tr>
    <td height="25" bgcolor="#FFFFFF">&nbsp;</td>
    <td height="25" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="3" cellspacing="1">
        <tr>
          <td> [ <a href="../msg/AddMsg/?username=<?=$username?>" target="_blank">發短消息</a> 
            ] [ <a href="../friend/add/?fname=<?=$username?>" target="_blank">加為好友</a> 
            ] [ <a href="../../space/?userid=<?=$r[userid]?>" target="_blank">會員空間</a> ] </td>
        </tr>
      </table></td>
  </tr>
  <tr> 
    <td width='17%' height="25" bgcolor="#FFFFFF"> <div align='left'>用戶名 </div></td>
    <td width='83%' height="25" bgcolor="#FFFFFF"> 
      <?=$username?>
    </td>
  </tr>
  <tr> 
    <td height="25" bgcolor="#FFFFFF">會員等級</td>
    <td height="25" bgcolor="#FFFFFF">
      <?=$level_r[$r[groupid]]['groupname']?>
    </td>
  </tr>
  <tr> 
    <td height="25" bgcolor="#FFFFFF">註冊時間</td>
    <td height="25" bgcolor="#FFFFFF"> 
      <?=$registertime?>
    </td>
  </tr>
