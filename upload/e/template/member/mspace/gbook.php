...
$url="<a href='../../../'>首頁</a>&nbsp;>&nbsp;<a href='../cp/'>會員中心</a>&nbsp;>&nbsp;管理留言";
  ...
  for (var i=0;i<form.elements.length;i++)
    ...
    if (e.name != 'chkall')
       e.checked = form.chkall.checked;
		...
		<form name="gbookform" method="post" action="index.php" onsubmit="return confirm('確認要刪除?');">
		<?php
		while($r=$empire->fetch($sql))
		{
			...
			if($r['uid'])
			{
				$msg=" / <a href='../msg/AddMsg/?username=$r[uname]' target='_blank'>消息回復</a>";
				$r['uname']="<b><a href='../../space/?userid=$r[uid]' target='_blank'>$r[uname]</a></b>";
			}
			$gbuname=$private.$r[uname]." / 留言於 ".$r[addtime]." / ip: ".$r[ip].":".$r[eipport].$msg;
		?>
          <tr> 
            <td height="25">
			<table width="100%" border="0" cellspacing="1" cellpadding="3"<?=$bgcolor?>>
                <tr> 
                  ...
                  <td width="78%">
                    <?=$gbuname?>                  </td>
                  <td width="17%"><div align="center">[<a href="#ecms" onclick="window.open('ReGbook.php?gid=<?=$r[gid]?>','','width=600,height=380,scrollbars=yes');">回復</a>]&nbsp;&nbsp;[<a href="index.php?enews=DelMemberGbook&gid=<?=$r[gid]?>" onclick="return confirm('確認要刪除?');">刪除</a>]</div></td>
                </tr>
                <tr> 
                  <td>&nbsp;</td>
            ...
            <td height="23"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="3">
                <tr>
                  ...
                  <td width="95%">
                    <?=$returnpage?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='submit' name='submit' value='批量刪除'>
