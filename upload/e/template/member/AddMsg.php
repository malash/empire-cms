...
?>
<?php
$public_diyr['pagetitle']='發送消息';
$url="<a href=../../../../>首頁</a>&nbsp;>&nbsp;<a href=../../cp/>會員中心</a>&nbsp;>&nbsp;<a href=../../msg/>消息列表</a>&nbsp;>&nbsp;發送消息";
require(ECMS_PATH.'e/template/incfile/header.php');
?>
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
          <form action="../../doaction.php" method="post" name="sendmsg" id="sendmsg">
            <tr class="header"> 
              <td height="23" colspan="2">發送消息</td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" height="25">標題</td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td height="25"><input name="to_username" type="text" id="to_username2" value="<?=$username?>">
                [<a href="#EmpireCMS" onclick="window.open('../../friend/change/?fm=sendmsg&f=to_username','','width=250,height=360');">選擇好友</a>] 
                *</td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td height="25">&nbsp;</td>
              <td height="25"><input type="submit" name="Submit" value="發送">
                &nbsp; 
