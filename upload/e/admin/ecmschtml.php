...
elseif($enews=="ReZtListHtml_all")//刷新所有專題頁面
{
	$start=$_GET['start'];
	$do=$_GET['do'];
	$from=$_GET['from'];
...
elseif($enews=="ReTtListHtml_all")//刷新所有標題分類頁面
{
	$start=$_GET['start'];
	$do=$_GET['do'];
	$from=$_GET['from'];
...
elseif($enews=="ReIndex")//刷新首頁
{
	ReIndex();
}
elseif($enews=="ReUserpageAll")//批量刷新自定義頁面
{
	ReUserpageAll($_GET['start'],$_GET['from'],$logininid,$loginin);
}
elseif($enews=="ReUserlistAll")//批量刷新自定義信息列表
{
	$start=$_GET['start'];
	$from=$_GET['from'];
	ReUserlistAll($start,$from,$logininid,$loginin);
}
elseif($enews=="ReUserjsAll")//批量刷新自定義JS
{
	$start=$_GET['start'];
	$from=$_GET['from'];
	ReUserjsAll($start,$from,$logininid,$loginin);
}
elseif($enews=="ReHot_NewNews")//刷新最新信息與熱門信息JS
{
	ReHot_NewNews();
}
...
elseif($enews=='ReSingleInfo')//刷新單信息頁面
{
	ReSingleInfo($logininid,$loginin);
}
elseif($enews=="ReZtHtml")//刷新專題
{
	$ztid=$_GET['ztid'];
	$ecms=$_GET['ecms'];
	ReZtHtml($ztid,$ecms);
}
elseif($enews=="ReTtHtml")//刷新標題分類
{
	$typeid=$_GET['typeid'];
	ReTtHtml($typeid);
}
elseif($enews=="ReSingleJs")//刷新單個欄目JS
{
	$classid=$_GET['classid'];
	$doing=$_GET['doing'];
	ReSingleJs($classid,$doing);
}
elseif($enews=="ReDtPage")//批量更新動態頁面
{
	ReDtPage($logininid,$loginin);
}
elseif($enews=="GoReListHtmlMore")//初使化刷新多欄目
{
...
elseif($enews=="GoReListHtmlMoreA")//初使化刷新多欄目(管理欄目)
{
...
elseif($enews=="ReListHtmlMore")//刷新多欄目
{
	$start=$_GET['start'];
	$classid=$_GET['classid'];
	$from=$_GET['from'];
...
elseif($enews=="ReListZtHtmlMore")//刷新多專題
{
	$start=$_GET['start'];
	$classid=$_GET['classid'];
	$from=$_GET['from'];
...
elseif($enews=="ReListTtHtmlMore")//刷新多標題分類
{
	$start=$_GET['start'];
	$classid=$_GET['classid'];
	$from=$_GET['from'];
...
elseif($enews=="ReClassPath")//恢復欄目目錄
{
	$start=$_GET['start'];
	ReClassPath($start);
}
elseif($enews=='UpdateClassInfosAll')//更新欄目信息數
{
