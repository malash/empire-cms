...
elseif($enews=='ChangeDataTableF')//轉移字段
{
	ChangeDataTableF($_GET,$logininid,$loginin);
}
elseif($enews=='ChangeDocDataTableF')//轉移字段(歸檔)
{
...
elseif($enews=="DefDataTable")//默認副表分表
{
	DefDataTable($_GET,$logininid,$loginin);
}
elseif($enews=="DelDataTable")//刪除副表分表
{
...
elseif($enews=='ChangeAllModForm')//批量更新模型表單
{
