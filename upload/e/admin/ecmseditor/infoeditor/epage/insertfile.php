...
function SetPicOk(ecms){
	...
	imgstr="<a href=\"<?=$filename?>\" target=_blank title=\"點擊查看原圖\">"+imgstr+"></a>";
	if(picsay!="")
	{
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableborder">
  <form name="insertpic" method="post" action="">
    <tr class="header"> 
      <td height="23">插入圖片設置</td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF">寬度 
    ...
    <tr>
      <td height="25" bgcolor="#FFFFFF">圖片下面顯示文字
        <input name="picsay" type="text" id="picsay" size="30"></td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <input type="button" name="Submit" value="插入圖片" onclick="SetPicOk(1);"> 
        <input type="button" name="Submit3" value="預覽圖片" onclick="SetPicOk(0);"> 
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableborder">
  <form name="insertpic" method="post" action="">
    ...
    <tr>
      <td height="25" bgcolor="#FFFFFF">FLASH下面顯示文字 
        <input name="picsay" type="text" id="picsay" size="30"></td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <input type="button" name="Submit" value="插入FLASH" onclick="SetPicOk(1);"> 
        <input type="button" name="Submit3" value="預覽效果" onclick="SetPicOk(0);"> 
        <input type="button" name="Submit2" value="取消" onclick="window.close();"></td>
    </tr>
    <tr> 
      <td height="23" bgcolor="#FFFFFF">
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableborder">
  <form name="insertpic" method="post" action="">
    ...
    <tr> 
      <td height="25" bgcolor="#FFFFFF">播放器下面顯示文字 
        <input name="picsay" type="text" id="picsay" size="30"></td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <input type="button" name="Submit" value="插入多媒體文件" onclick="SetPicOk(1);"> 
        <input type="button" name="Submit3" value="預覽效果" onclick="SetPicOk(0);"> 
        <input type="button" name="Submit2" value="取消" onclick="window.close();"></td>
    </tr>
    <tr> 
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableborder">
  <form name="insertpic" method="post" action="">
    <tr class="header"> 
      <td height="23">插入附件設置</td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF">附件名稱 
        <input name="picsay" type="text" id="picsay" size="30"></td>
    </tr>
    <tr> 
