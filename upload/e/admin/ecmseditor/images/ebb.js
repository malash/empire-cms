...
clckcnt = 0;
function clckcntr() {clckcnt++;if(clckcnt > 1) {if(clckcnt > 2) { return false; }alert('貼子已經發出了......\n\n' + '請等待片刻......\n\n' + '不要重複按提交鍵，謝謝！');return false;}return true;}
...
tPopShow=5000;		//顯示tShow豪秒後關閉提示，1000為1秒
showPopStep=20;
popOpacity=90;		//提示框的透明度,百分比，數字越小越透明
fontcolor="#000000";
bgcolor="#ffffff";
bordercolor="#cccccc";
