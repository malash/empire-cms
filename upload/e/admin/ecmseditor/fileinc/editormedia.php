...
<div align="center">大小</div></td>
    <td width="21%">
<div align="center">上傳時間</div></td>
    <td width="10%">
<div align="center">選擇</div></td>
  </tr>
  <?php
  ...
  <tr> 
    ...
    <td colspan="5" bgcolor="#FFFFFF">&nbsp;&nbsp;
      <?=$returnpage?>
      &nbsp;&nbsp; <input type="submit" name="Submit33" value="刪除選中" onclick="document.dofile.enews.value='TDelFile_all';"> 
