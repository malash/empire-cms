...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
  <tr class="header"> 
    ...
    <td width="21%"><div align="center">上傳時間</div></td>
  ...
  while($r=$empire->fetch($sql))
  {
	...
	$filetype=substr(GetFiletype($r[filename]),1);//取得文件類型
	//文件
...
?>
  ...
  <tr> 
    ...
    <td colspan="5" bgcolor="#FFFFFF">&nbsp;&nbsp;
      <?=$returnpage?>
      &nbsp;&nbsp; <input type="submit" name="Submit32" value="刪除選中" onclick="document.dofile.enews.value='TDelFile_all';">
    </td>
  </tr>
</table>
