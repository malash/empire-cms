...
//菜單顯示
$showfastmenu=$empire->gettotal("select count(*) as total from {$dbtbpre}enewsmenuclass where classtype=1 limit 1");//常用菜單
$showextmenu=$empire->gettotal("select count(*) as total from {$dbtbpre}enewsmenuclass where classtype=3 limit 1");//擴展菜單
...
<TITLE>帝國網站管理系統 － 最安全、最穩定的開源CMS系統</TITLE>
...
<td height="60">
  ...
  <form name="menuform" id="menuform">
	...
	<input type="hidden" name="onclickmenu" value="">
      <TR> 
            <TD width="180"><div align="center"><a href="main.php<?=$ecms_hashur['whehref']?>" target="main" title="帝國網站管理系統"><img src="adminstyle/1/images/logo.gif" border="0"></a></div></TD>
		<TD height="60"> 
                  ...
                  <TR align=middle> 
                    <TD width=60 onmouseover="if(document.menuform.onclickmenu.value!='dosysmenu'){this.style.backgroundColor='#8CBDEF';}" onmouseout="if(document.menuform.onclickmenu.value!='dosysmenu'){this.style.backgroundColor='';}" onclick="DoOnclickMenu('dosysmenu');JumpToLeftMenu('adminstyle/1/left.php?ecms=system<?=$ecms_hashur['ehref']?>');" style="CURSOR: hand" id="dosysmenu"> 
                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                        <tr> 
                          <td><div align="center"><IMG height=32 src="adminstyle/1/images/system<?=$menufiletype?>" width=32 border=0 title="系統設置"></div></td>
                        </tr>
                        <tr> 
                          <td height="20">
<div align="center"><font color="#FFFFFF"><strong>系統</strong></font></div></td>
                        </tr>
                      </table></TD>
...
<div align="center"><font color="#FFFFFF"><strong>信息</strong></font></div></td>
                    ...
                    <TD width=60 onmouseout="if(document.menuform.onclickmenu.value!='doclassmenu'){this.style.backgroundColor='';}" onmouseover="if(document.menuform.onclickmenu.value!='doclassmenu'){this.style.backgroundColor='#8CBDEF';}" onclick="DoOnclickMenu('doclassmenu');JumpToLeftMenu('adminstyle/1/left.php?ecms=classdata<?=$ecms_hashur['ehref']?>');" style="CURSOR: hand" id="doclassmenu"> 
                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                        <tr> 
                          <td><div align="center"><img height=32 src="adminstyle/1/images/class<?=$menufiletype?>" width=32 border=0 title="欄目管理"></div></td>
                        </tr>
                        <tr> 
                          <td height="20">
<div align="center"><font color="#FFFFFF"><strong>欄目</strong></font></div></td>
                        </tr>
                      </table></TD>
...
<div align="center"><font color="#FFFFFF"><strong>模板</strong></font></div></td>
                    ...
                    <TD width=60 onmouseout="if(document.menuform.onclickmenu.value!='dousermenu'){this.style.backgroundColor='';}" onmouseover="if(document.menuform.onclickmenu.value!='dousermenu'){this.style.backgroundColor='#8CBDEF';}" onclick="DoOnclickMenu('dousermenu');JumpToLeftMenu('adminstyle/1/left.php?ecms=usercp<?=$ecms_hashur['ehref']?>');" style="CURSOR: hand" id="dousermenu"> 
                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                        <tr> 
                          <td><div align="center"><IMG height=32 src="adminstyle/1/images/usercp<?=$menufiletype?>" width=32 border=0 title="用戶和會員"></div></td>
                        </tr>
                        <tr> 
                          <td height="20">
<div align="center"><font color="#FFFFFF"><strong>用戶</strong></font></div></td>
                        </tr>
                      </table></TD>
...
<div align="center"><font color="#FFFFFF"><strong>其他</strong></font></div></td>
					  ...
					  <TD width=60 onmouseout="if(document.menuform.onclickmenu.value!='doextmenu'){this.style.backgroundColor='';}" onmouseover="if(document.menuform.onclickmenu.value!='doextmenu'){this.style.backgroundColor='#8CBDEF';}" onclick="DoOnclickMenu('doextmenu');JumpToLeftMenu('adminstyle/1/left.php?ecms=extend<?=$ecms_hashur['ehref']?>');" style="CURSOR:hand;<?=$showextmenu?'':'display:none'?>" id="doextmenu"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                        <tr> 
                          <td><div align="center"><IMG height=32 src="adminstyle/1/images/extend<?=$menufiletype?>" width=32 border=0 title="擴展菜單項"></div></td>
                        </tr>
                        <tr> 
                          <td height="20">
<div align="center"><font color="#FFFFFF"><strong>擴展</strong></font></div></td>
                        </tr>
                      </table> </TD>
...
<div align="center"><font color="#FFFFFF"><strong>常用</strong></font></div></td>
                    ...
                    <TD width="301"><div align="right"><font color="#ffffff">用戶：<a href="user/EditPassword.php<?=$ecms_hashur['whehref']?>" target="main"><font color="#ffffff"><b><?=$loginin?></b></font></a>&nbsp;&nbsp;&nbsp;[<a href="#ecms" onclick="if(confirm('確認要退出?')){JumpToMain('ecmsadmin.php?enews=exit<?=$ecms_hashur['href']?>');}"><font color="#ffffff">退出</font></a>]&nbsp;&nbsp;</font></div></TD>
                  </TR>
                </TBODY>
              </TABLE>
              ...
              <TABLE class=flyoutMenu border=0>
                <TBODY>
                  <TR align=middle> 
                    ...
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('ListAllInfo.php?ecmscheck=1<?=$ecms_hashur['ehref']?>');" onmouseover="over(this)" onmouseout="out(this)">審核信息</TD>
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('workflow/ListWfInfo.php<?=$ecms_hashur['whehref']?>');" onmouseover="over(this)" onmouseout="out(this)">簽發信息</TD>
					<?php
					if($r[dopl])
					{
					?>
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('openpage/AdminPage.php?leftfile=<?=urlencode('../pl/PlNav.php'.$ecms_hashur['whehref'])?>&mainfile=<?=urlencode('../pl/PlMain.php'.$ecms_hashur['whehref'])?>&title=<?=urlencode('管理評論')?><?=$ecms_hashur['ehref']?>');" onmouseover="over(this)" onmouseout="out(this)">管理評論</TD>
					<?php
					}
					?>
					...
					<TD width="60" class="flyoutLink" onclick="JumpToMain('special/UpdateZt.php<?=$ecms_hashur['whehref']?>');" onmouseover="over(this)" onmouseout="out(this)">更新專題</TD>
					<?php
					if($r[dochangedata])
					{
					?>
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('ReHtml/ChangeData.php<?=$ecms_hashur['whehref']?>');" onmouseover="over(this)" onmouseout="out(this)">數據更新</TD>
					<?php
					}
					?>
					<TD width="60" class="flyoutLink" onclick="JumpToMain('info/InfoMain.php<?=$ecms_hashur['whehref']?>');" onmouseover="over(this)" onmouseout="out(this)">數據統計</TD>
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('infotop.php<?=$ecms_hashur['whehref']?>');" onmouseover="over(this)" onmouseout="out(this)">排行統計</TD>
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('main.php<?=$ecms_hashur['whehref']?>');" onmouseover="over(this)" onmouseout="out(this)">後台首頁</TD>
                    <TD width="60" class="flyoutLink" onclick="window.open('../../');" onmouseover="over(this)" onmouseout="out(this)">網站首頁</TD>
                    <TD width="60" class="flyoutLink" onclick="window.open('map.php<?=$ecms_hashur['whehref']?>','','width=1250,height=760,scrollbars=auto,resizable=yes,top=80,left=120');" onmouseover="over(this)" onmouseout="out(this)">後台地圖</TD>
