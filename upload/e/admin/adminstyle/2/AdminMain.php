...
<td height="60">
  ...
  <TABLE width="100%" height="60" border=0 cellpadding="0" cellSpacing=0 background="adminstyle/2/images/topbg.gif">
    <TBODY>
      <TR> 
        <TD width="180"><div align="center"><a href="main.php<?=$ecms_hashur['whehref']?>" target="main" title="帝國網站管理系統"><img src="adminstyle/2/images/logo.gif" border="0"></a></div></TD>
		<TD height=60> 
                ...
                <TBODY>
                  <TR align=middle> 
                    ...
                    <TD width=80 onmouseout="this.style.backgroundColor=''" onmouseover="this.style.backgroundColor='#8CBDEF';tododisplay('ecmssysmenu');" onclick="return false;" style="CURSOR: hand"> 
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
                          <td><div align="center"><IMG height=32 src="adminstyle/2/images/other<?=$menufiletype?>" width=32 border=0 title="功能菜單"></div></td>
                        </tr>
                        <tr> 
                          <td height="23"><div align="center"><font color="#FFFFFF"><strong>功能菜單</strong></font></div></td>
                        </tr>
                      </table></TD>
                    <TD width="351"><div align="right"><font color="#ffffff">用戶：<a href="user/EditPassword.php<?=$ecms_hashur['whehref']?>" target="main"><font color="#ffffff"><b><?=$loginin?></b></font></a>&nbsp;&nbsp;&nbsp;[<a href="#ecms" onclick="if(confirm('確認要退出?')){JumpToMain('ecmsadmin.php?enews=exit<?=$ecms_hashur['href']?>');}"><font color="#ffffff">退出</font></a>]&nbsp;&nbsp;</font></div></TD>
                  </TR>
                </TBODY>
              </TABLE>
        ...
        <TD class=flyoutMenu width="1%"> </TD>   
		    <TD width="99%" height="27"> 
              ...
              <TABLE class=flyoutMenu border=0 id="ecmssysmenu" style="display:none">
                <TBODY>
                  <TR align=middle> 
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('user/EditPassword.php<?=$ecms_hashur['whehref']?>');" onmouseover="over(this)" onmouseout="out(this)">修改資料</TD>
					<?php
					if($r[doclass])
					{
					?>
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('ListClass.php<?=$ecms_hashur['whehref']?>');" onmouseover="over(this)" onmouseout="out(this)">管理欄目</TD>
					<?php
					}
					?>
					<?php
					...
					{
					?>
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('special/ListZt.php<?=$ecms_hashur['whehref']?>');" onmouseover="over(this)" onmouseout="out(this)">管理專題</TD>
					<?php
					}
					?>
					<?php
					...
					{
					?>
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('ListInfoClass.php<?=$ecms_hashur['whehref']?>');" onmouseover="over(this)" onmouseout="out(this)">管理採集</TD>
					<?php
					}
					?>
					<?php
					...
					{
					?>
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('tool/feedback.php<?=$ecms_hashur['whehref']?>');" onmouseover="over(this)" onmouseout="out(this)">管理反饋</TD>
					<?php
					}
					?>
					<?php
					...
					{
					?>
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('DownSys/ListError.php<?=$ecms_hashur['whehref']?>');" onmouseover="over(this)" onmouseout="out(this)">錯誤報告</TD>
					<?php
					}
					?>
                  </TR>
