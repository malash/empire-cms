...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
  <tr> 
    <td width="50%">位置：日誌管理 &gt; <a href="ListDolog.php<?=$ecms_hashur['whehref']?>">管理操作日誌</a></td>
    <td><div align="right" class="emenubutton">
        <input type="button" name="Submit5" value="管理登陸日誌" onclick="self.location.href='ListLog.php<?=$ecms_hashur['whehref']?>';">
      </div></td>
  </tr>
</table>
...
<form name="form2" method="post" action="ListDolog.php" onsubmit="return confirm('確認要刪除?');">
  ...
  <?=$ecms_hashur['form']?>
    <tr class="header"> 
      ...
      <td width="27%"> 
        <div align="center"><a href="ListDolog.php?orderby=3&mydesc=<?=$logtimedesc.$search2?>">操作時間</a></div></td>
  ...
  ?>
    <tr bgcolor="#DBEAF5" id=log<?=$r[logid]?>> 
      ...
      <td height="25"> 
        <div align="center">[<a href="ListDolog.php?enews=DelDoLog&logid=<?=$r[logid]?><?=$ecms_hashur['href']?>" onclick="return confirm('確認要刪除此日誌?');">刪除</a> 
  ...
  ?>
    <tr bgcolor="#FFFFFF"> 
      <td height="25" colspan="5"> 
        <?=$returnpage?>&nbsp;&nbsp;
        <input type="submit" name="Submit" value="批量刪除"> <input name="enews" type="hidden" id="phome" value="DelDoLog_all">&nbsp;
        <input type=checkbox name=chkall value=on onClick=CheckAll(this.form)>
        選中全部 </td>
    </tr>
  </table>
</form>
<form action="ListDolog.php" method="post" name="dellogform" id="dellogform" onsubmit="return confirm('確認要刪除?');">
