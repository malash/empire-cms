...
$empire->query("insert into `{$dbtbpre}enewsf`($sys_selectf) values(NULL,'title','標題','text','".addslashes($sysf_titletr[0])."','標題','0','1','1','".addslashes($sysf_titletr[2])."','0','CHAR','100','1','$tid','$tbname','0','','0','0','0','".addslashes($sysf_titletr[1])."','0','','0','60','0','0','','','','','','','0','0');");

$sysf_specialr=explode('[!--sys.special.field--]',$sysfdata);
$sysf_specialtr=explode('[!--sys.qf.exp--]',$sysf_specialr[1]);
$empire->query("insert into `{$dbtbpre}enewsf`($sys_selectf) values(NULL,'special.field','特殊屬性','','".addslashes($sysf_specialtr[0])."','特殊屬性','0','1','0','".addslashes($sysf_specialtr[2])."','0','','0','0','$tid','$tbname','0','','0','0','0','".addslashes($sysf_specialtr[1])."','0','','0','','0','0','','','','','','','0','0');");

$sysf_titlepicr=explode('[!--sys.titlepic--]',$sysfdata);
$sysf_titlepictr=explode('[!--sys.qf.exp--]',$sysf_titlepicr[1]);
$empire->query("insert into `{$dbtbpre}enewsf`($sys_selectf) values(NULL,'titlepic','標題圖片','img','".addslashes($sysf_titlepictr[0])."','標題圖片','0','1','1','".addslashes($sysf_titlepictr[2])."','0','CHAR','120','1','$tid','$tbname','0','','0','0','0','".addslashes($sysf_titlepictr[1])."','0','','0','60','0','0','','','','','','','0','0');");

$sysf_newstimer=explode('[!--sys.newstime--]',$sysfdata);
$sysf_newstimetr=explode('[!--sys.qf.exp--]',$sysf_newstimer[1]);
$empire->query("insert into `{$dbtbpre}enewsf`($sys_selectf) values(NULL,'newstime','發佈時間','text','".addslashes($sysf_newstimetr[0])."','發佈時間','0','1','1','".addslashes($sysf_newstimetr[2])."','0','INT','11','1','$tid','$tbname','0','','1','0','0','".addslashes($sysf_newstimetr[1])."','0','','0','','0','0','','','','','','','0','0');");
