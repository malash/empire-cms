...
?>
<p><b>子欄目列表：</b><?=$class_r[$bclassid]['classname']?></p>
<?php
}
else
{
...
while($r=$empire->fetch($sql))
{
	...
	{
		$showsonclass=" <small>(<a href=\"$indexurl\">下級欄目</a>)</small>";
	}
?>
...
<p><a href="<?=$returnurl?>">返回</a> <a href="index.php?style=<?=$wapstyle?>">網站首頁</a></p>
<?php
DoWapFooter();
?>